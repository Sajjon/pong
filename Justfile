# Pong — task runner (https://github.com/casey/just)
#
# Prerequisites:
...
fmt:
    @if command -v swiftformat >/dev/null 2>&1; then swiftformat Pong PongTests; fi
